...
export const CONFIG = {"title":"潮間釣夢","genre":"海釣養成","visual":"fishing","accent":"#7bdff2","actions":{"cast":"拋竿","reel":"收線","wait":"放線","spot":"更換釣點","upgrade":"升級釣竿"},"help":"依張力表掌握收放線時機。不同天候與釣點有獨特魚種，圖鑑收錄六種魚即告完成。","test":["cast","wait","reel","cast","wait","reel","spot","cast","wait","reel","upgrade"],"id":"pg-seacast"};
